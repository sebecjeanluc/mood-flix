...
const categories = {
	EmotionMovieAssociations: {
		Happy: ['romantic+comedies', 'fiction+happy', 'Inspirational'],
		Sad: ['Drama', 'Romance', 'Comedy'],
		Gloomy: ['Thriller', 'Horror', 'Documentary'],
		Angry: ['Adventure', 'Sports', 'Drama'],
		Romantic: ['Romantic+Comedy', 'Romance', 'Drama'],
		Excited: ['Thriller', 'Plot-Twist', 'Adventure'],
		Weird: ['Documentary', 'Satire', 'Challenging'],
	},
